        ...
        <div className="relative z-10 w-full max-w-md mx-auto px-6">
          <div className="flex justify-center mb-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900 dark:text-white">KaavachAI</span>
            </div>
          </div>
          
          <h2 className="text-center text-3xl font-extrabold text-gray-900 dark:text-white mb-8">
            Sign in to KaavachAI
          </h2>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white/90 dark:bg-gray-800/90 text-gray-500 dark:text-gray-300 backdrop-blur-sm">New to Kaavach AI?</span>
                </div>
              </div>
