  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2">Loading <span className="text-orange-600">Kaavach AI</span>...</h2>
...
const Home: React.FC = () => {
  ...
  const cards = [
      {
        title: "XSS Exploits",
        description: "Learn how to identify and exploit Cross-Site Scripting vulnerabilities safely.",
      ...
      {
        title: "SQL Injection",
        description: "Understand SQLi techniques and how attackers manipulate databases.",
      ...
      {
        title: "CSRF Attacks",
        description: "Practice Cross-Site Request Forgery exploitation and prevention.",
      ...
      },
      {
        ...
        description: "Explore ways weak authentication can be bypassed and mitigated.",
      ...
      },
      {
        ...
        description: "Learn to handle and exploit insecure file upload mechanisms.",
      ...
      },
      {
        ...
        description: "Understand RCE attack vectors and defenses.",
      ...
      },
      {
        ...
        description: "Explore SSRF exploitation and real-world scenarios.",
      ...
      },
      {
        ...
        description: "Understand privilege escalation and proper access management.",
        problems: topicMap["binary search"]?.count || 0,
        difficulty: "Medium to Hard",
        color: "from-indigo-500 via-purple-600 to-violet-600",
        icon: <Star className="h-6 w-6" />,
      ...
      },
      {
        ...
        description: "ELearn to exploit and prevent unauthorized access to objects.",
        problems: topicMap["binary search"]?.count || 0,
        difficulty: "Medium to Hard",
        color: "from-indigo-500 via-purple-600 to-violet-600",
        icon: <Star className="h-6 w-6" />,
      ...
      },
      {
        ...
        description: "Identify and exploit common misconfigurations in web applications.",
        problems: topicMap["binary search"]?.count || 0,
        difficulty: "Medium to Hard",
        color: "from-indigo-500 via-purple-600 to-violet-600",
        icon: <Star className="h-6 w-6" />,
  ...
  return(
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-2">Loading <span className="text-orange-600">KaavachAI</span>...</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">This will take 15 seconds</p>
        <p className="italic text-sm text-gray-600 dark:text-gray-300 transition-all duration-500">{tips[tipIndex]}</p>
      </div>
    </div>
            ...
            <div className="z-10 space-y-8 card-animate-in">
              <div className="space-y-3">
                ...
                <p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-2xl card-animate-in" style={{ animationDelay: '0.2s' }}>
                  Join thousands of security researchers uncovering vulnerabilities and sharpening their ethical hacking skills through our comprehensive bug bounty platform.
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className={`text-xl max-w-3xl mx-auto ${isDark ? "text-gray-300" : "text-gray-600"}`}>
               Uncover curated bug bounty programs and step-by-step paths to transform from beginner to elite security researcher.
              </p>
        ...
        >
          ...
          <div className="relative">
            <div className="text-center mb-16">
              ...
              <p className={`text-xl max-w-3xl mx-auto ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                Our platform equips you with everything you need to uncover vulnerabilities and grow as a world-class security researcher.
              </p>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              Discover vulnerabilities, submit proof-of-concepts, and earn rewards on Kaavach AI — a collaborative bug bounty platform where security researchers and ethical hackers compete, learn, and get recognized for safeguarding the digital world.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {[
                  { icon: <Mail className="h-5 w-5" />, text: "singhbhadauriyadivyanshi@gmail.com" },
                  { icon: <Phone className="h-5 w-5" />, text: "+91 7800013056" },
                  { icon: <MapPin className="h-5 w-5" />, text: "Kanpur, India" },
                ].map((contact, index) => (
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2025 Kaavach AI. All rights reserved. Built with ❤️ for developers.</p>
